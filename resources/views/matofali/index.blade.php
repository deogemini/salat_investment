                    ...
                    <tbody>
                        ...
                        @foreach ($matofali as $matofali)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info btn-sm" title="Edit" data-bs-toggle="modal"
                                        data-bs-target="#showModal-edit"
                ...
                <div class="card-body form-steps">
                    <form id="registration_form" action="{{ route('matofali.ingizaStock') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="idadi_matofali_stock"
                                placeholder="andika idadi ya matofali unayoingiza">
                        </div>
                ...
                <form action="{{ route('mashamba.update') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success" id="update_btn"> <i class=" bx bxs-save"></i>
                                Update</button>
                        </div>
                    </div>
                </form>
